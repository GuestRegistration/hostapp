...
class AppPerformance extends StatefulWidget {
  @override
  _AppPerformanceState createState() => _AppPerformanceState();
}

class _AppPerformanceState extends State<AppPerformance> {
