define(['dart_sdk', 'packages/hostapp/generated_plugin_registrant', 'packages/flutter_web_plugins/flutter_web_plugins', 'packages/hostapp/main'], function(dart_sdk, packages__hostapp__generated_plugin_registrant, packages__flutter_web_plugins__flutter_web_plugins, packages__hostapp__main) {
  'use strict';
  ...
  const generated_plugin_registrant = packages__hostapp__generated_plugin_registrant.generated_plugin_registrant;
  const plugin_registry = packages__flutter_web_plugins__flutter_web_plugins.src__plugin_registry;
  const main = packages__hostapp__main.main;
  ...
  dart.trackLibraries("packages/hostapp/main_web_entrypoint", {
    "package:hostapp/main_web_entrypoint.dart": main_web_entrypoint
  }, {
