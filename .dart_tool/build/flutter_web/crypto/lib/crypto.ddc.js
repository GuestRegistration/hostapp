define(['dart_sdk', 'packages/collection/src/comparators', 'packages/convert/convert', 'packages/typed_data/typed_buffers'], function(dart_sdk, packages__collection__src__comparators, packages__convert__convert, packages__typed_data__typed_buffers) {
  'use strict';
  ...
  hash_sink.HashSink = class HashSink extends core.Object {
    ...
    [_finalizeData]() {
      ...
      if (dart.equals(this[_endian], typed_data.Endian.big)) {
        ...
        byteData[$setUint32](dart.notNull(offset) + 4, lowBits, this[_endian]);
      } else {
        byteData[$setUint32](offset, lowBits, this[_endian]);
        byteData[$setUint32](dart.notNull(offset) + 4, highBits, this[_endian]);
      }
    }
    [_roundUp](val, n) {
  ...
  (sha512_slowsinks._Sha64BitSink.new = function(sink, _digest) {
    ...
    sha512_slowsinks._Sha64BitSink.__proto__.new.call(this, sink, 32);
    ;
